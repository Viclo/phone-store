           ...
           <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Transferencias
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                        ...
                                        <!--<template v-if="oveja == transferencia.origen || oveja == transferencia.destino">-->
                                        <td>
                                            ...
                                            <template v-else-if="transferencia.estado=='Pendiente'">
                                                ...
                                                <button type="button"
                                                        ...
                                                        @click="agregarTransferencia(transferencia,transferencia.id)"
                                        ...
                                        <td v-text="transferencia.destino"></td>
                    ...
                    <div class="card-body">
                        <div class="form-group row border">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" v-model="destino">
                                            ...
                                            <option v-for="sucursal in arraySucursal" :key="sucursal.id" :value="sucursal.nombre">
                                                <template v-if="sucursal.nombre != oveja">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control" v-model="fechat">
                            </div>
                            <div class="col-md-12">
    ...
    export default {
        ...
        methods : {
            ...
            validarTransferencia(){
                ...
                for(var i=0;i<this.arrayDetalle.lenght;i++){
                    if((this.arrayDetalle[i].cantidad)*1>(this.arrayDetalle[i].stock)*1) {this.errorMostrarMsjTransferencia.push("El stock de transferencia no puede ser mayor al que se tiene en almacenes")};
                };
