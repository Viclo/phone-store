<template>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="cargarExcelCelH()" class="btn btn-check">
                            <i class="icon-doc"></i>&nbsp;ExcelCelHipermaxy
                        </button>
                        <button type="button" @click="cargarExcelCelIC()" class="btn btn-check">
                            <i class="icon-doc"></i>&nbsp;ExcelCelICNorte
                        </button>
                        <button type="button" @click="cargarExcelAccs()" class="btn btn-check">
                            <i class="icon-doc"></i>&nbsp;ExcelAccs
                        </button>
                        <button type="button" @click="cargarExcelAccsH()" class="btn btn-check">
                            <i class="icon-doc"></i>&nbsp;ExcelAccsHipermaxy
                        </button>
                        <button type="button" @click="cargarExcelAccsIC()" class="btn btn-check">
                            <i class="icon-doc"></i>&nbsp;ExcelAccsICNorte
                        </button>
                        </template>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <h1>Excel de Fecha de Almacen</h1>
                            </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control" v-model="diaP">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control" v-model="mesP">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control" v-model="anioP">
                                        <option value="2019">2019</option>
                                        <option value="2020">2020</option>
                                    </select>                                        
                                </div>
                                <div class="col-md-2">
                                    <select class="form-control" v-model="catP">
                                        <option value="1">Celulares</option>
                                        <option value="2">Accessorios</option>
                                    </select>                                        
                                </div>
                                 <button type="submit" @click="excelFecha(sucu,diaP,mesP,anioP,catP)" class="btn btn-primary"><i class="fa fa-search"></i>Excel de Fecha</button>
                        ...
                        <table class="table table-responsive table-bordered table-striped table-sm">
                            <thead>
                                <tr>
                                    <th v-if="lobo == 1 || lobo==3">Opciones</th>
                                    <th>Código</th>
                                    <th>Nombre</th>
                                    <th>Categoría</th>
                                    <th>Sucursal</th>
                                    <th>Marca</th>
                                    <th>Precio Venta</th>
                                    <th v-if="lobo == 1 || lobo==3">Precio Compra</th>
                                    <th>Stock</th>
                                    <th v-if="lobo == 1 || lobo==3">Proveedor</th>
                            ...
                            <tbody>
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                        ...
                                        <button type="button" @click="abrirModal('articulo','actualizar',articulo)" class="btn btn-warning btn-sm">
                                          <i class="icon-pencil"></i>
                                            ...
                                            <template v-if="articulo.condicion==1">
                                                <button type="button" class="btn btn-info btn-sm" @click="abrirModalCan(articulo)">
                                    ...
                                    <td v-if="lobo == 1 || lobo==3">{{articulo.precio_compra}}</td>
                                    <td v-text="articulo.stock"></td>
                                    <td v-text="articulo.nomp" v-if="lobo == 1 || lobo==3"></td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row" v-if="lobo == 1 || lobo==3">
            ...
            <!--Fin del modal-->
            <div class="modal fade" tabindex="-1" :class="{'mostrar' : modalCan}" role="dialog" aria-labelledby="myModalLabel" style="display: none;height: 100%;overflow-y: auto;" aria-hidden="true">
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" v-text="tituloModalCan"></h4>
                            <button type="button" class="close" @click="cerrarModalCan()" aria-label="Close">
                              <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                               <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="date" v-model="fechadev" class="form-control" placeholder="">                                        
                                    </div>
                                </div>
                                <div v-show="errorArticuloDev" class="form-group row div-error">
                                    <div class="text-center text-error">
                                        <div v-for="error in errorMostrarMsjArticuloDev" :key="error" v-text="error">
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" @click="cerrarModalCan()">Cerrar</button>
                            <button type="button" class="btn btn-primary" @click="devolverArticuloModal()">Devolver Esta Cantidad</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            cargarExcelCelH(){
                window.open('/articulo/excelCelH','_blank');
            },
            cargarExcelCelIC(){
                window.open('/articulo/excelCelIC','_blank');
            },
            cargarExcelAccs(){
                window.open('/articulo/excelAccs','_blank');
            },
            cargarExcelAccsH(){
                window.open('/articulo/excelAccsH','_blank');
            },
            cargarExcelAccsIC(){
                window.open('/articulo/excelAccsIC','_blank');
            },
            excelFecha(sucu,diaP,mesP,anioP,catP){
                window.open('/articulo/excelFecha?sucu='+ sucu +'&diaP='+ diaP +'&mesP='+ mesP +'&anioP='+ anioP+'&catP='+catP ,'_blank');
            },
            selectCategoria(){
                let me=this;
            ...
            validarDevolucion(){
                this.errorArticuloDev=0;
                this.errorMostrarMsjArticuloDev =[];

                if (this.stock>this.topstock) this.errorMostrarMsjArticuloDev.push("No puede Devolver stock mayor al que se tiene.");
                if (this.fechadev=='') this.errorMostrarMsjArticuloDev.push("Seleccione una fecha de devolucion.");
                
                if (this.errorMostrarMsjArticuloDev.length) this.errorArticuloDev = 1;

                return this.errorArticuloDev;
            },
            cerrarModal(){
                this.modal=0;
                this.tituloModal='';
            ...
            abrirModalCan(data =[]){
                this.modalCan=1;
                this.tituloModalCan='Devolver Accesorio';
                ...
                this.proveedor = data['nomp'];
                this.topstock = data['stock'];
            },
            cerrarModalCan(){
                this.modalCan=0;
                this.tituloModalCan='';
