            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <template v-if="arlle!='registrado'">
                            <button type="button" class="btn btn-primary" @click="llenarArrayArticulo()">Agregar Codigos o Imeis</button>
                        </template>
                        <template v-else-if="arlle=='registrado'">
                            <button type="button" class="btn btn-primary" @click="llenarArrayArticulo()" disabled>Agregar Codigos o Imeis</button>
                        </template>
                            <hr>
                        <div class="form-group row border">
                            <div class="table-responsive col-md-12">
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayLLenado.length">
                                        <tr v-for="detalle in arrayLLenado" :key="detalle.id">
                                            ...
                                            <td v-else>
                                                <!--<span style="color:red;" v-show="detalle.codigo!=detalle.codigo">Repetido</span>-->
                    ...
                    <div class="card-body">
                        ...
                        <template v-if="estado=='Endeuda'">
                            <div class="form-group row">
                                <h2>Deuda: Debe {{(totalParcial)-(pago1)-(pago2)}} $</h2>
                            </div>
                        </template>
                        ...
                        <div class="form-group row border">
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" v-model="fechai2">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" v-model="fechai3">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
        ...
        methods : {
            ...
            agregarArticulo(){
                ...
                axios.post('/ingreso/agregar',{
                    ...
                    if(response.data == 1){
                        ...
                        'Uno de los celulares ya esta registrado',
                        'success'
                        ).catch(function (error) {
                    console.log(error);
                    });
            ...
            agregarIngreso(id){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.fechai=arrayIngresoT[0]['fecha_hora'];
