...
Vue.component('negocio', require('./components/Negocio.vue'));
Vue.component('telefono', require('./components/Telefono.vue'));
...
Vue.component('transferencia', require('./components/Transferencia.vue'));
...
Vue.component('reported', require('./components/ReporteDeuda.vue'));
