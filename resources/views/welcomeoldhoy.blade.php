...
<div class="jumbotron ">
        ...
        <hr class="my-4">
        <h2 style="color: white" class=" text-center font-weight-bold">Somos pioneros con nuestro sistema de pago en nuestra forma de negociar con mas de 20 años de experiencia</h2>
...
<div class="fh5co-narrow-content" id="primero" >
    <div class="row animate-box" data-animate-effect="fadeInLeft">
        ...
        <img src="img/mirage.png" class="img-fluid" alt="Responsive image" style="max-width: 100%;">
