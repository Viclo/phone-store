                                        ...
                                        <section class="use_sasu padding_top">
                                                <div class="container">
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="single_feature">
                                                                <i class="fas fa-memory fa-5x" style="color:#02387c;"></i>
                                                                <div class="single_feature_part">
                                                                    <img src="img/icon/camera.png" alt="">
                                                                    <h4>Ram</h4>
                                                                    <p>{{$telefono->memoria}} </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <div class="row justify-content-center">
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div class="single_feature">
                                                                    <i class="fab fa-windows fa-5x" style="color:#02387c;"></i>
                                                                    <div class="single_feature_part">
                                                                        <img src="img/icon/android.png" alt="" width="50" height="50">
                                                                        <h4>Sistema Operativo</h4>
                                                                        <p>{{$telefono->sistema}}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div class="single_feature">
                                                                    <i class="fas fa-gamepad fa-5x" style="color:#02387c;"></i>
                                                                    <div class="single_feature_part">
                                                            ...
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div class="single_feature">
                                                                    <i class="fas fa-microchip fa-5x" style="color:#02387c;"></i>
                                                                    <div class="single_feature_part">
                                                                        <img src="img/icon/battery.png" alt="">
                                                                        <h4>Procesador</h4>
                                                                        <p>{{$telefono->procesador}} </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
