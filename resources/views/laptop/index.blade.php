...
@section('contenido')
<form  method="get" action="/buscarLap" enctype="multipart/form-data">
    {{ csrf_field() }}
...
<div class="fh5co-narrow-content">
    <h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">LAPTOP'S</h2>
    <div class="row animate-box" data-animate-effect="fadeInLeft">
        
        <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
            @foreach($telefonos as $telefono)
           
            <a href="/laptops/{{$telefono->id}}">
