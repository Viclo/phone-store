...
<div class="fh5co-narrow-content" id="primero" >
    ...
    <p>Con esta opción ofrecemos a nuestros clientes de PHONEBOL un servicio basado en , puede buscar uno de nuestros celulares y llevarselo dejando como parte de pago su celular actual, apenas registre sus datos nuestro personal se contactara con usted a la brevedad posible para 
        ...
        <p>ADVERTENCIA Se tratara de dar respuesta a todos los mensajes pero al no conseguirla en un determinado tiempo de 3 dias Se opto por no negociar</p>
                    ...
                    <div class="col-lg-4">
                      <div class="card mb-5 mb-lg-0">
                        <div class="card-body">
                          ...
                          <h6 class="card-price text-center">Telefonos Gama Alta</h6>
                          <hr>
                          <ul class="fa-ul">
                            <li><span class="fa-li"><i class="fas fa-check"></i></span>Single User</li>
                            <li><span class="fa-li"><i class="fas fa-check"></i></span>5GB Storage</li>
                    ...
                    <div class="col-lg-4">
                      <div class="card mb-5 mb-lg-0">
                        <div class="card-body">
                                ...
                                <h6 class="card-price text-center">Telefonos Gama Ocasional</h6>
                          <hr>
                          <ul class="fa-ul">
                            <li><span class="fa-li"><i class="fas fa-check"></i></span><strong>5 Users</strong></li>
        ...
        <div class="col-md-6">
            <div class="fh5co-feature animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="fh5co-text">
                    <h3>Teléfonos</h3>
                    <p>Ofrecemos Variedad de Teléfonos de ultima generación ,nuevos y ocasionales, en cuanto salen al mercado. </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="fh5co-feature animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="fh5co-text">
                    <h3>Accesorios</h3>
                    <p>Gran variedad de accesorios para todo tipo de articulo que ofrecemos para su comodidad como ser cases, protectores, auriculares y muchas cosas más. </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="fh5co-feature animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="fh5co-text">
                    ...
                    <p>Puede contactarse con nosotrós de manera sencilla, cotizar y adquirir lo que prefiera.Utilizando los telefonos, la pagina web o el personal en tienda.</p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="fh5co-feature animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="fh5co-text">
                    <h3>Mantenimiento</h3>
                    <p>Ofrecemos un servicio tecnico de mantenimiento, reparacion, decodificacion y actualizaciones de software, contamos con expertos de mas de 20 años de experiencía trabajando siempre para dar lo mejor. </p>
                </div>
            </div>
        </div>
...
<div class="fh5co-cards">
    <div class="fh5co-narrow-content">
        ...
        <div class="fh5co-flex-wrap">
            <div class="fh5co-card animate-box" data-animate-effect="fadeInLeft">
                <h5>Sucursal</h5>
                <p>Apertura de nuevas sucursales en Cochabamba.</p>
                <p>Y muy pronto sucursales a nivel nacional</p>
            </div>
            <div class="fh5co-card animate-box" data-animate-effect="fadeInLeft">
                <h5>Mercado</h5>
